...
class DBManager:
    def __init__(self):
        # 连接数据库
        self.engine = create_engine("mysql+pymysql://root:root@127.0.0.1:3306/weibo?charset=utf8", poolclass=NullPool)
...
class TopicDetail(Base):
    ...
    detail_url = Column(Text(collation='utf8mb4_unicode_ci'))
